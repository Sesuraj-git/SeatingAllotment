...
# Form implementation generated from reading ui file 'promptDialog.ui'
#
...
class Ui_Dialog(QDialog):
    ...
    def select(self):
        self.deleteLater()
        ClassSelect(centralWidget=self.centralWidget, directory="classes.txt", status=0)

    def upload(self):
        self.deleteLater()
        directory = QFileDialog.getOpenFileName()
        directory = directory[0]
        ClassSelect(centralWidget=self.centralWidget, directory=directory, status=1)

    def retranslateUi(self):
        _translate = QtCore.QCoreApplication.translate
        self.setWindowTitle(_translate("Dialog", "Dialog"))
        self.label.setText(_translate("Dialog", "Upload Classes file as .txt file"))
